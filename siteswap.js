...
let showTwosCheckbox = document.getElementById("show-twos");
...
let gravity;
let showTwosAsHolds = false;
let LHoutsideThrows = false;
let RHoutsideThrows = false;
...
showTwosCheckbox.onchange = () => {
    showTwosAsHolds = !showTwosAsHolds;
};

document.getElementById("lh-outside").onchange = () => {
    LHoutsideThrows = !LHoutsideThrows;
};
document.getElementById("rh-outside").onchange = () => {
    RHoutsideThrows = !RHoutsideThrows;
};
